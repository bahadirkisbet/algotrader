...
This module provides a validator for the configuration file.
It is used to validate the configuration file, and to get the configuration values.
"""
...
class ConfigValidator:
    ...
    DEFAULT_VALUES = {
        ...
        ConfigSection.EXCHANGE: {"default_interval": "1m"},
    ...
    FIELD_TYPES = {"max_connection_limit": int, "max_log_size": int, "log_backup_count": int}
    ...
    def _validate_field(cls, section: str, field: str, value: str) -> List[str]:
        ...
        if field in cls.FIELD_TYPES:
            try:
                ...
                errors.append(
                    f"Invalid type for [{section}].{field}: '{value}' "
