...
class TestServiceInitializer:
    ...
    async def test_service_initialization(self):
        ...
        with (
            patch("modules.config.config_manager.ConfigManager.get_config") as mock_get_config,
            patch("modules.log.log_manager.LogManager.get_logger") as mock_get_logger,
            ...
            )  # Called in initialize_logger and initialize_config
