...
from domains.strategy_engine.strategies.moving_average_crossover import (
...
class TestSimulationResult:
    ...
    def test_simulation_result_creation(self):
        ...
        config = SimulationConfig(start_date=datetime(2023, 1, 1), end_date=datetime(2023, 12, 31))
...
class TestSimulationEngine:
    ...
    async def test_run_simulation_integration(self):
        ...
        strategy = MovingAverageCrossoverStrategy(
            name="TestMAStrategy", symbols=["BTCUSDT"], fast_period=5, slow_period=10
        )
        ...
        with (
            patch.object(self.engine.exchange, "connect", new_callable=AsyncMock) as mock_connect,
